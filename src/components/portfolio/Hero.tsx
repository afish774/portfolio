...
export function HeroSidebar() {
    ...
    return (
        <aside
            ...
            className="hidden h-fit max-h-[calc(100svh-2.5rem)] overflow-y-auto [&::-webkit-scrollbar]:hidden w-[clamp(15rem,16vw,18rem)] shrink-0 flex-col gap-3 lg:flex pb-2 pointer-events-auto"
            style={{ opacity: 0, scrollbarWidth: "none" }}
        >
            <div className={`shrink-0 p-4 transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] ${isDarkSection ? "bg-[#1a1a1a] rounded-[2rem] border border-white/5" : "bg-card rounded-xl border border-transparent"}`}>
                ...
                <p data-fade className={`mt-3.5 text-[12.5px] leading-relaxed text-left ${transitionClass} ${isDarkSection ? "text-white/60" : "text-muted-foreground"}`}>
            ...
            <div className="shrink-0 grid grid-cols-2 gap-2">
                <div data-slot="stat-1" className={`relative flex flex-col items-center justify-center p-4 overflow-hidden border shadow-sm before:absolute before:inset-0 before:bg-gradient-to-br before:from-white/5 before:to-transparent transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] ${isDarkSection ? "bg-[#1a1a1a] rounded-[1.5rem] border-white/5" : "bg-card rounded-xl border-white/5"}`}>
                    <p className={`font-display text-[2rem] font-black z-10 ${isDarkSection ? "text-[#ffeb3b]" : "text-primary"}`}>6+</p>
                ...
                <div data-slot="stat-2" className={`relative flex flex-col items-center justify-center p-4 overflow-hidden border shadow-sm before:absolute before:inset-0 before:bg-gradient-to-br before:from-white/5 before:to-transparent transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] ${isDarkSection ? "bg-[#1a1a1a] rounded-[1.5rem] border-white/5" : "bg-card rounded-xl border-white/5"}`}>
                    <p className={`font-display text-[2rem] font-black z-10 ${isDarkSection ? "text-[#ffeb3b]" : "text-primary"}`}>1+</p>
            ...
            <nav className={`shrink-0 relative flex flex-col gap-1 rounded-[1.25rem] p-2 overflow-hidden ${transitionClass} ${isDarkSection ? "bg-[#1a1a1a]" : "bg-card"}`}>
                <div 
                    className="pointer-events-none absolute inset-0 bg-[#1a1a1a] transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)]" 
                    style={{ 
                        transform: active === "projects" ? "translateY(0%)" : "translateY(110%)",
                ...
                {SECTIONS.map(({ id, label, Icon }) => {
                    ...
                    return (
                        <a
                            ...
                            className="relative flex items-center gap-3.5 rounded-full px-4 py-2.5 text-[15px] font-display font-bold uppercase tracking-wider leading-none transition-colors group z-10"
                        >
                            {isActive && id !== "home" && (
                                <motion.div
            ...
            <div data-fade className="shrink-0 overflow-hidden py-1 flex group">
            ...
            <button
                ...
                className={`shrink-0 flex items-center justify-between rounded-xl px-5 py-3 text-[13px] font-medium ${transitionClass} ${isDarkSection ? "bg-[#222] text-white/50 hover:bg-[#333]" : "bg-card text-muted-foreground hover:bg-muted hover:text-foreground"}`}
            >
            ...
            <a
                href="#contact"
                data-slot="cta"
                className="shrink-0 rounded-xl bg-primary py-3.5 text-center font-display text-[15px] font-black tracking-wide text-primary-foreground transition-transform hover:-translate-y-0.5"
            >
                Book a Call
            </a>
        </aside>
