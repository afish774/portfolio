...
export function HeroSidebar() {
    ...
    return (
        <aside
            ...
            className="hidden h-screen w-[clamp(14.5rem,15vw,17rem)] shrink-0 flex-col justify-between gap-4 [@media(max-height:800px)]:gap-2 p-3 lg:flex pointer-events-auto"
            style={{ opacity: 0 }}
        >
            <div className={`p-5 [@media(max-height:800px)]:p-3 transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] ${isDarkSection ? "bg-[#1a1a1a] rounded-[2rem] border border-white/5" : "bg-card rounded-xl border border-transparent"}`}>
                ...
                <p data-fade className={`mt-6 [@media(max-height:800px)]:mt-2 text-sm leading-relaxed text-left ${transitionClass} ${isDarkSection ? "text-white/60" : "text-muted-foreground"}`}>
            ...
            <div className="grid grid-cols-2 gap-2">
                <div data-slot="stat-1" className={`relative flex flex-col items-center justify-center p-5 [@media(max-height:800px)]:p-3 overflow-hidden border shadow-sm before:absolute before:inset-0 before:bg-gradient-to-br before:from-white/5 before:to-transparent transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] ${isDarkSection ? "bg-[#1a1a1a] rounded-[1.5rem] border-white/5" : "bg-card rounded-xl border-white/5"}`}>
                    <p className={`font-display text-4xl [@media(max-height:800px)]:text-3xl font-black z-10 ${isDarkSection ? "text-[#ffeb3b]" : "text-primary"}`}>6+</p>
                    <p className={`mt-2 [@media(max-height:800px)]:mt-1 text-center text-[10px] font-bold uppercase tracking-widest z-10 ${transitionClass} ${isDarkSection ? "text-white/90" : "text-muted-foreground"}`}>Projects<br />Delivered</p>
                </div>
                <div data-slot="stat-2" className={`relative flex flex-col items-center justify-center p-5 [@media(max-height:800px)]:p-3 overflow-hidden border shadow-sm before:absolute before:inset-0 before:bg-gradient-to-br before:from-white/5 before:to-transparent transition-all duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] ${isDarkSection ? "bg-[#1a1a1a] rounded-[1.5rem] border-white/5" : "bg-card rounded-xl border-white/5"}`}>
                    <p className={`font-display text-4xl [@media(max-height:800px)]:text-3xl font-black z-10 ${isDarkSection ? "text-[#ffeb3b]" : "text-primary"}`}>1+</p>
                    <p className={`mt-2 [@media(max-height:800px)]:mt-1 text-center text-[10px] font-bold uppercase tracking-widest z-10 ${transitionClass} ${isDarkSection ? "text-white/90" : "text-muted-foreground"}`}>Years of<br />Experience</p>
                </div>
            </div>

            <nav className={`relative flex flex-col gap-1.5 [@media(max-height:800px)]:gap-1 rounded-xl p-2.5 [@media(max-height:800px)]:p-1.5 overflow-hidden ${transitionClass} ${isDarkSection ? "bg-[#1a1a1a]" : "bg-card"}`}>
                ...
                {SECTIONS.map(({ id, label, Icon }) => {
                    ...
                    return (
                        <a
                            ...
                            className="relative flex items-center gap-3.5 rounded-full px-4 py-3 [@media(max-height:800px)]:py-1.5 text-[18px] [@media(max-height:800px)]:text-[16px] font-display font-bold uppercase tracking-wider leading-none transition-colors group z-10"
                        >
            ...
            <div data-fade className="overflow-hidden py-1.5 [@media(max-height:800px)]:py-1 flex group">
                    ...
                    {[...LOGOS, ...LOGOS].map((logo, i) => (
                        logo.src ? (
                            <img
                                ...
                                src={logo.src}
                                alt={logo.name}
                                className={`h-5 [@media(max-height:800px)]:h-4 object-contain transition-all duration-300 ${isDarkSection ? "brightness-0 invert opacity-50" : "brightness-0 invert-0 opacity-70"}`}
                            />
                        ) : (
                            <span
                                key={`1-${logo.id}-${i}`}
            ...
            <button
                ...
                className={`flex items-center justify-between rounded-xl px-5 py-4 [@media(max-height:800px)]:py-2.5 text-sm font-medium ${transitionClass} ${isDarkSection ? "bg-[#222] text-white/50 hover:bg-[#333]" : "bg-card text-muted-foreground hover:bg-muted hover:text-foreground"}`}
            >
            ...
            <a
                href="#contact"
                data-slot="cta"
                className="rounded-xl bg-primary py-4 [@media(max-height:800px)]:py-2.5 text-center font-display text-base font-black tracking-wide text-primary-foreground transition-transform hover:-translate-y-0.5"
            >
                Book a Call
            </a>
        </aside>
